...
const OKOCE_7_TOP_STAGES = [
  { id: "P1", title: "P1 - Pendaftaran", desc: "Registrasi anggota OK OCE & legalitas dasar enterprise.", color: "text-red-400" },
...
export function TabOkoceMentoring({ diagnostic }: TabOkoceMentoringProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="mentoring-card rounded-3xl border border-red-500/40 bg-gradient-to-br from-red-950/60 via-slate-900/90 to-slate-950/90 p-6 md:p-8 backdrop-blur-2xl shadow-2xl space-y-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 border-b border-white/10 pb-6">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <span className="rounded-full bg-red-500/20 border border-red-500/40 px-3 py-0.5 text-[11px] font-bold text-red-300">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 rounded-2xl bg-gradient-to-r from-red-600 to-red-600 px-5 py-3 text-xs font-bold text-white shadow-lg shadow-red-500/25 hover:from-red-500 hover:to-red-500 transition-all hover:scale-[1.02]"
            >
      ...
      <div className="mentoring-card rounded-3xl border border-white/10 bg-slate-900/80 p-6 md:p-8 backdrop-blur-2xl shadow-xl space-y-4">
        <div className="flex items-center justify-between border-b border-white/10 pb-4">
          ...
          <span className="rounded-full bg-red-500/20 border border-red-500/30 px-3 py-1 text-[11px] font-bold text-red-300">
            7 Tahapan OK OCE
          </span>
        </div>
            ...
            return (
              <div
                ...
                className={`flex flex-col justify-between rounded-2xl border p-3.5 transition-all ${
                  isRecommended
                    ? "border-red-500 bg-red-950/60 shadow-lg shadow-red-500/20 ring-1 ring-red-400"
