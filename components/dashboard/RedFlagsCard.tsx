...
export function RedFlagsCard({ gap, index }: RedFlagsCardProps) {
  ...
  const cardBorder = isCritical
    ...
    : "border-red-500/30 bg-gradient-to-b from-red-950/30 via-slate-900/90 to-slate-950/90";
    ...
    >
      ...
      <div className="mt-4 flex items-center justify-between border-t border-white/5 pt-3 text-[11px]">
        <span className="text-slate-400">
          Est. Time: <strong className="text-red-300">{gap.estimatedTimeToSolve}</strong>
        </span>
