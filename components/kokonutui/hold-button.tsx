  ...
  return (
    <button
      ...
      className={cn(
        ...
        isHolding && "border-red-500/50 text-white scale-98",
    ...
    >
      ...
      <div
        className="absolute inset-0 bg-gradient-to-r from-red-600 to-red-600 opacity-60 transition-all duration-75"
